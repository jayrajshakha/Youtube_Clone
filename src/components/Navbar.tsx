...
import { AiFillYoutube, AiOutlineSearch , AiOutlineVideoCameraAdd , AiOutlineBell} from "react-icons/ai";
import { MdKeyboardVoice } from "react-icons/md";
// import {BsCameraVideoFill,BsBell} from 'react-icons/bs'
  ...
  return (
    <div className=" flex justify-between items-center h-14 px-16">
      ...
      <div className="flex items-center w-[732px] h-10">
        <div className="flex  mt-2 ml-8 w-[640px] pr-1  pl-4 h-10">
          <form
            action=""
            className="pt-0.5 border mx-2 rounded-2xl w-[536px] "
          >
            <input
              type="search"
              ...
              placeholder="Search"
            />
            <AiOutlineSearch className="inline-block h-6 w-6  " />
          </form>
          <MdKeyboardVoice className=" inline-block p-1 h-10 w-10" />
        </div>
      </div>
      ...
      <div className="flex items-center justify-evenly ">
       ...
       <span className="bg-red-500 rounded-full h-4 text-center w-4 text-xs top-[3px] right-[4px] absolute  ">9+</span>
       </div>
